...
/**
 * /reportes/contables/cashflow-mensual — wrapper que linkea al HTML server-side.
 */
...
export default function CashflowMensualPage() {
  ...
  const buildUrl = (autoPrint: boolean): string => {
    ...
    return `${API_BASE}/reportes/contables/cashflow-mensual.html?${qs}`;
  };
    ...
    <div className="mx-auto max-w-[900px] space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500">
          Entradas vs salidas mes a mes del año + saldo acumulado corriente.
          Útil para detectar meses negativos antes que pase.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-hairline bg-white p-6 shadow-card">
        ...
        <p className="mt-4 text-[11px] italic text-ink-500">
          <LineChart className="inline h-3 w-3" strokeWidth={1.5} /> Los datos
          vienen de <code>core.movimientos</code> (cargados via ETL Excel +
