...
const SHORTCUTS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: "g p", description: "Mis pendientes (bandeja personal)" },
      { keys: "g v", description: "Vouchers contables" },
      { keys: "g o", description: "Órdenes de Compra" },
      { keys: "g i", description: "Inbox (mailbox AI)" },
      { keys: "g f", description: "F29 mensual" },
      { keys: "g t", description: "F22 anual" },
      { keys: "g e", description: "Empresas (admin)" },
      { keys: "g b", description: "Bitácora (audit trail)" },
