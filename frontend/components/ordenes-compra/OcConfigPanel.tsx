...
/**
 * R152RRRR · OcConfigPanel
 *
 * Panel de configuración del módulo Órdenes de Compra. Antes vivía como
 * página /admin/oc-branding; ahora se monta como tab "Configuración"
 * dentro de /ordenes-compra para tener toda la operación en un solo lugar.
 *
 * Editor por empresa:
 *   - Branding visual del PDF (logo + color + GG nombre/cargo).
 *   - Firma colectiva RHO + lista de firmantes adicionales.
 *   - Emails TO/CC para auto-envío del PDF al crearse OC desde correo.
 */
