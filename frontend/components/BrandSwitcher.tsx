  ...
  return (
    <div ref={ref} className="relative flex items-center gap-2 min-w-0 flex-1">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={cn(
          "flex items-center gap-3 min-w-0 flex-1 rounded-xl px-1 py-1 -mx-1",
      ...
      {open && (
        <div
          className={cn(
            "absolute left-0 top-full mt-1 w-72 rounded-xl border border-hairline",
            "bg-white shadow-glass z-50 max-h-96 overflow-y-auto",
        ...
        >
          ...
          <button
            ...
            className={cn(
              "w-full flex items-center gap-3 px-3 py-2.5 text-left hover:bg-ink-50",
              "dark:hover:bg-ink-800/40 border-b border-hairline dark:border-ink-800",
            )}
          >
            <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white ring-1 ring-hairline">
              <Image
                src="/logos/cehta.png"
                alt="Cehta"
                width={32}
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-ink-500">Vista global · FIP CEHTA ESG</p>
            </div>
            {activeCodigo === null && (
              <Check className="size-4 text-cehta-green shrink-0" />
            )}
          </button>
          ...
          {empresas.map((emp) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "w-full flex items-center gap-3 px-3 py-2.5 text-left hover:bg-ink-50",
                  "dark:hover:bg-ink-800/40 last:border-b-0",
